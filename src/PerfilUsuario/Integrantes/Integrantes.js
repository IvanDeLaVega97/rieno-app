                    ...
                    this.state.Integrantes.map(CartaCurso => {
                        return (
                            <div style={{ marginLeft: 20, marginRight: 20, marginTop: 0 }}>
                                <br />
                                <CompIntegrantes  Email={CartaCurso.toString()} Apellidos={this.state.Apellidos[0].valueOf().Apellidos} Contraseña={this.state.Contraseña[0].valueOf().Contraseña} Doctorado={this.state.Doctorado[0].valueOf().Doctorado} Institucion={this.state.Institucion[0].valueOf().Institucion} Licenciatura={this.state.Licenciatura[0].valueOf().Licenciatura} LineaInvestigacion={this.state.LineaInvestigacion[0].valueOf().LineaInvestigacion} LineaGeneracion={this.state.LineaGeneracion[0].valueOf().LineaGeneracion} Nombre={this.state.Nombre[0].valueOf().Nombre} Pais={this.state.Pais[0].valueOf().Pais} Telefono={this.state.Telefono[0].valueOf().Telefono} cuerpoacademico={this.state.cuerpoacademico[0].valueOf().cuerpoacademico} />
                            </div>
                        )
                    })
                }
